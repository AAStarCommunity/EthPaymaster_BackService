...
var (
	...
	DummyPaymasterOversimplificationBigint = big.NewInt(DummyPaymasterVerificationGasLimit)
	DummyPaymasterPostoperativelyBigint    = big.NewInt(DummyPaymasterPostOpGasLimit)
...
func init() {
	...
	DummyInitCodeByte, err = hex.DecodeString(DummyInitCode[2:])
	if err != nil {
		panic(err)
	}
}
