...
var (
	...
	DummyPaymasterVerificationgaslimitBigint = big.NewInt(DUMMY_PAYMASTER_VERIFICATIONGASLIMIT)
	DummyPaymasterPostopGaslimitBigint       = big.NewInt(DUMMY_PAYMASTER_POSTOP_GASLIMIT)
	DummyVerificationgaslimitBigint          = big.NewInt(DUMMY_VERIFICATIONGASLIMIT)
